...
curl -i -X PUT -H "Accept:application/json" -H "Content-Type:application/json" localhost:8083/connectors/inventory-connector/config -d "@edit-source.json"
curl -i -X PUT -H "Accept:application/json" -H "Content-Type:application/json" localhost:8083/connectors/inventory-connector/config -d "@edit-sink.json"

curl -X POST ${HOST}/connectors/${CONNECTOR}/tasks/${TASK}/restart
